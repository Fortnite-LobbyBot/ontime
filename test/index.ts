...
import nextime from '../src/lib/nextime';
...
test('ever second/UTC', (t) => {
	t.strictEqual(`${nextime('s', '', new Date('2014-11-01T23:59:59Z'), true)}`, `${new Date('2014-11-02T00:00:00Z')}`);
	t.strictEqual(`${nextime('s', '', new Date('2014-12-31T23:59:59Z'), true)}`, `${new Date('2015-01-01T00:00:00Z')}`);
	t.end();
});
